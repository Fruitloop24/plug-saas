...
const getTierFeatures = (tier: Tier): string[] => {
  ...
  if (tier.id === 'free') {
    features.push('Your feature here');
    features.push('Ready for $$');
  } else if (tier.id === 'pro') {
    features.push('Your API Feautures');
    features.push('Get started now');
  } else if (tier.id === 'developer') {
    features.push('White label options');
    features.push('Let us deploy for you');
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
      ...
      <nav className="flex justify-between items-center px-6 md:px-12 py-6 bg-white/80 backdrop-blur-lg border-b border-slate-200/50 sticky top-0 z-50">
        ...
        <div className="flex gap-4 items-center">
          <a
            href="https://github.com/Fruitloop24/plug-saas"
            target="_blank"
        ...
        <div className="relative text-center px-6 md:px-8 py-20 md:py-32 max-w-6xl mx-auto">
          ...
          <div className="text-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 bg-white/10 backdrop-blur-sm border border-white/30 text-white rounded-lg hover:bg-white/20 transition-all text-sm font-medium"
            >
